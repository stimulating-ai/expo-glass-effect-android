 ...
 * ```
 */
export function LiquidGlassProvider({ backgroundColor = '#FFFFFF', children, style, ...props }) {
    ...
    return (<NativeView backgroundColor={backgroundColor} style={style} {...props}>
      {children}
    </NativeView>);
}
//# sourceMappingURL=LiquidGlassProvider.js.map